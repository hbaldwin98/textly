...
<div class="h-full overflow-y-auto p-4 space-y-4">
  ...
  <div class="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3 space-y-2">
    <div class="text-xs font-medium text-gray-600 dark:text-gray-400">Storage Statistics</div>
    <div class="grid grid-cols-2 gap-2 text-xs">
      ...
      <div>
        <span class="text-gray-500 dark:text-gray-400">History Items:</span>
        <span class="font-medium text-gray-900 dark:text-gray-100 ml-1">
          {$storageStats.history}
        </span>
      </div>
    </div>
    <div class="pt-1 border-t border-gray-200 dark:border-zinc-700">
      <span class="text-gray-500 dark:text-gray-400 text-xs">Storage Size:</span>
      <span class="font-medium text-gray-900 dark:text-gray-100 ml-1 text-xs">
  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white dark:bg-zinc-800 rounded-lg p-6 max-w-sm mx-4">
      ...
      <div class="flex gap-3">
        ...
        <button
          class="flex-1 px-3 py-2 text-sm bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-md transition-colors"
