<script lang="ts">
  ...
  // Function to get context from clipboard or props
  function getContext(): string {
    return context || clipboardState.context || "";
  }

  // Function to get selected text from clipboard or props
  function getSelectedText(): string {
    return selectedText || clipboardState.selectedText || "";
  }
